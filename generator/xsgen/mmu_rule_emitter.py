...
FAULT_MASK_BY_RESULT_AND_REQUESTOR = {
    ...
    ("page_fault", "hlv"): ("XSAM_MMU_FAULT_LOAD_PAGE", "XSAM_MMU_CAUSE_LOAD_PAGE_FAULT"),
    ("page_fault", "hlvx"): ("XSAM_MMU_FAULT_LOAD_PAGE", "XSAM_MMU_CAUSE_LOAD_PAGE_FAULT"),
    ("page_fault", "hsv"): ("XSAM_MMU_FAULT_STORE_PAGE", "XSAM_MMU_CAUSE_STORE_PAGE_FAULT"),
